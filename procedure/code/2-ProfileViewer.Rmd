...
CrossProf <- read.csv("../../data/derived/public/crossprof2.txt", header=FALSE, sep = " ", col.names=c("Junk","Distance","Elevation"))[c(2,3)]
LongProf <- read.csv("../../data/derived/public/longprof2.txt", header=FALSE, sep = " ", col.names=c("Junk","Distance","Elevation"))[c(2,3)]
```
...
ggplot(LongProf) +
       ...
       geom_line(size = 1) + # The "size" argument allows us to increase or decrease our point size.
       scale_color_gradient(low = "gray", high = "red") +
       theme_light() +
       labs(x = "Distance along the transect (m)", y = "Elevation (masl)", title = "Longitudinal Profile of Extracted Reach")
```
...
DpthBf_Max <- 1.7499 # Insert the maximum bankfull depth from your point/reach of interest here, replacing the 8 left of the hash #
...
ggplot(CrossProf) +
       ...
       xlim(80,450) + # Sets the x-axis limits. Adjust this value as you zoom in to the correct area.
       ylim(1210,1220) + # Sets the y-axis limits. Adjust this value as you zoom in to the correct area.
       scale_color_gradient(low = "green", high = "brown") +
